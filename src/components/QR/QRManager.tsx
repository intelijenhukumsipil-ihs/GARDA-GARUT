...
export const QRManager: React.FC<QRManagerProps> = ({
  ...
  // Send WhatsApp Verification Alert to Gateway (081316403160)
      ...
      <div className="bg-slate-900 border border-slate-800 p-4 sm:p-6 lg:p-8 rounded-3xl text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-300 max-w-2xl font-medium">
            Seluruh aset fisik infrastruktur daerah & dokumen rekomendasi terpadu dilengkapi Kode QR unik terverifikasi untuk mencegah pemalsuan di lapangan. Terhubung langsung ke WhatsApp Gateway Server (081316403160).
          </p>
        </div>
